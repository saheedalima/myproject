...
import 'package:myproject/RegistrationPage.dart';
    ...
    DevicePreview(
      ...
      builder: (context) => MaterialApp(
        debugShowCheckedModeBanner: false,
          useInheritedMediaQuery: true, home: FirstPage()), // Wrap your app
    ),
  );
}
...
class FirstPage extends StatefulWidget {
  @override
  State<FirstPage> createState() => _FirstPageState(); //to convert myapp which is currently immutable tp a mutable state
}
